...
public class customerView {
    ...
    public static String listAllUsers(String cssTableClass, DbConn dbc) {
        System.out.println("This is a test message for Lab 3.");
        ...
        try {
            ...
            String sql = "select customer_id, firstName, lastName, cus_loginName, cus_password, cus_username, cus_DOB, user_role_id from sp17_3308_tug25055.customer";
            ...
            sb.append("<th style='text-align:right'>DOB</th>");
