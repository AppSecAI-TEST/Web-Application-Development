...
public class DbConn {
    ...
    private String dbName = "SP11_2308_sallyk";
    ...
    public DbConn() {
        try {
            ...
            try {
                ...
                String url = "jdbc:mysql://localhost:3307/"+this.dbName+"?user=sallyk&password=Vaca1415";

                if (isTemple()) {
                    // SP11_2308_sallyk is the name of my database/schema on cis-linux2
                    url = "jdbc:mysql://cis-linux2.temple.edu/"+this.dbName+"?user=sallyk&password=Vaca1415";
                }
