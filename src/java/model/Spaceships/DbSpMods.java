...
public class DbSpMods {
    ...
    public static StringData insert(StringData inputData, DbConn dbc) {
        ...
        if (errorMsgs.getCharacterCount() > 0) {  // at least one field has an error, don't go any further.
            ...
            if (errorMsgs.errorMsg.length() == 0) {
                ...
                errorMsgs.errorMsg = "You cannot insert this spaceship. Model Name & Model Type must be unique.";
            }
    ...
    public static StringData update(StringData inputData, DbConn dbc) {
        ...
        if (errorMsgs.getCharacterCount() > 0) {  // at least one field has an error, don't go any further.
            ...
            if (errorMsgs.errorMsg.length() == 0) {
                ...
                errorMsgs.errorMsg = "You cannot update this spaceship. Model Name & Model Type must be unique.";
            }
        } // customerId is not null and not empty string.
        return errorMsgs;
    } // update
    ...
    public static StringData delete(StringData inputData, DbConn dbc) {
        ...
        errorMsgs.spaceshipId = ValidationUtils.integerValidationMsg(inputData.spaceshipId, true);
        ...
        if (errorMsgs.getCharacterCount() > 0) {  // at least one field has an error, don't go any further.
            ...
            if(inputData.spaceshipId.compareTo("") == 0 || inputData.spaceshipId == null){
                errorMsgs.errorMsg = " ";  
            ...
            // Start preparing SQL statement
            String sql = "DELETE FROM sp17_3308_tug25055.spaceship WHERE spaceship_id = ?";
            ...
            // Encode string values into the prepared statement (wrapper class).
            pStatement.setString(1, inputData.spaceshipId);
            ...
            if (errorMsgs.errorMsg.length() == 0) {
                ...
                errorMsgs.errorMsg = "You cannot delete this spaceship. This spaceship has records";
            }
        } // customerId is not null and not empty string.
        return errorMsgs;
    } // delete
