    ...
    private void connect(boolean isTemple) {
        try {
            ...
            try {
                ...
                String url = "jdbc:mysql://localhost:3307/SP12_2308_sallyk?user=sallyk&password=Vaca1415";

                if (isTemple) {
                    // SP11_2308_sallyk is the name of my database/schema on cis-linux2
                    url = "jdbc:mysql://cis-linux2.temple.edu/SP12_2308_sallyk?user=sallyk&password=Vaca1415";
                }
