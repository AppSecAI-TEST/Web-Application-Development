...
<jsp:include page="headToContent.jsp"/>
            <div style="padding: 5%">
                ...
                <h2 class="labName">Metadata Challenge</h2>
                <p class="labDescrip"> For this lab, I learned how to extract all tables from my sql and to create a dynamically generated table using the
                    ResultSetMetaData interface. The challenge for this project was simply how to format the result set at runtime which was easily managed
                    with if statements. Aside from that, the only other challenge was figuring out how to set option values without a number which was solved by 
                    using table names. Aside from that, the project was very easy. In order to the work done for this project, click the links below.
                </p>
                <ul>
                    <li>List Table Fields: <a href="listFields.jsp" style="text-decoration: none;">listFields.jsp</a></li>
                    <li>Report Writer: <a href="report.jsp" style="text-decoration: none;">report.jsp</a></li>
                </ul>
            </div>
